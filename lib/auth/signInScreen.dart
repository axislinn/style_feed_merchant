...
import 'package:flutter_application_1/auth/passwordTextFormField.dart';
import 'package:flutter_application_1/auth/signUpScreen.dart';
import 'package:flutter_application_1/auth/forgotPassword.dart';
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                ...
                // Get.to(SignUpScreen(isRegistering: false));
                // Get.toNamed('/signUp');
